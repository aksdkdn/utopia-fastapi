...
#             detail=f"MinIO bucket 생성/확인 실패: {str(e)}",
#         )
...
#         "image/webp": ".webp",
#     }
#     return content_type_to_ext.get(content_type or "", ".jpg")
...
#             raise HTTPException(
#                 status_code=status.HTTP_400_BAD_REQUEST,
#                 detail="JPG, PNG, WEBP 형식의 이미지 파일만 업로드할 수 있습니다.",
#             )
